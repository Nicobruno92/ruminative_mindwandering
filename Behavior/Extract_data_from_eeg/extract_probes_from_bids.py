...
# =============================================================================
BIDS_RAW_ROOT = "<PATH_TO_YOUR_BIDS_RAW_ROOT>"
# Write to the canonical path used by downstream analyses
OUTPUT_FILE = "<PATH_TO_YOUR_REPO_ROOT>/results/Behavior/probe_data/probe_level_aggregated_data.csv"
...
def main():
    ...
    meta_path = Path("<PATH_TO_YOUR_REPO_ROOT>/metadata_CyberSART.xlsx")
    if meta_path.exists():
