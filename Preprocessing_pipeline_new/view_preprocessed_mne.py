...
PLOT_KIND = "raw"  # options: 'auto', 'epochs', 'raw', 'evoked'
...
def find_mne_files(path: str, subject_id: str, sart_session: str) -> List[str]:
    """
...
def main() -> None:
    ...
    files = find_mne_files(DATA_PATH, SUBJECT_ID, SART_SESSION)
